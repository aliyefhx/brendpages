    ...
    return (
        <>
            ...
            <div className=" mt-4 md:mt-8 text-lg md:text-2xl text-center px-1">
                <div> hi mənim adım<span className="font-bold">Brend UserBot </span> ,</div>
                <div className="font-normal ml-1">I'm a <span className="text-pink-600 font-bold">Web Developer Şirvan \n Aliyefh bgm aliy!</span></div>
            </div>
